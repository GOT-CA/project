...
<body>
    ...
    <form action="./getClass.php" method="get" target="resultbox" class="layui-form">
    	<div class="layui-form-item">
    		...
    		<div class="layui-inline">
        		...
        		<?php
                        ...
                        echo '<select name="did" lay-verify="required" lay-search="">';
        ...
        <div  style="text-align:center; margin-top: 50px;"><input name="submit" type="submit" class="layui-btn"  value="查询"></div>
