...
session_start();
if(!isset($_SESSION["teacher"])||!$_SESSION["login"]==true){
    ...
    $nowuser=mysqli_query($db,"select name from teacher where tid='$userid'");
?>
<html>
<head>
        	...
        	<div class="layui-side-scroll">
        		<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo" style="margin-right: 10px;">
                    <li class="layui-nav-item">
                      ...
                      <dl class="layui-nav-child">
                        <dd><a href="./queueStudent.php" target="frame">查询学生</a></dd>
                    ...
                    <li class="layui-nav-item">
                      ...
                      <dl class="layui-nav-child">
                        <dd><a href="./queueDept.php" target="frame">院系信息</a></dd>
                        <dd><a href="./queueMajor.php" target="frame">专业列表</a></dd>
                      </dl>
                    </li>
                    <li class="layui-nav-item">
                      <a href="javascript:;">课程管理</a>
                      <dl class="layui-nav-child">
                        <dd><a href="./queueCourse.php" target="frame">课程查询</a></dd>
                    ...
                    <li class="layui-nav-item">
                      ...
                      <dl class="layui-nav-child">
                        ...
                        <dd><a href="./queueRetake.php" target="frame">重修补考</a></dd>
                      </dl>
                    </li>
                    <li class="layui-nav-item">
                      <a href="javascript:;">数据统计</a>
                      <dl class="layui-nav-child">
                        <dd><a href="./scoreStatistic.php" target="frame">成绩统计</a></dd>
                        <dd><a href="./classStatistic.php" target="frame">选课统计</a></dd>
