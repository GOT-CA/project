...
from student natural join takes natural join (select cname,cid,credit from course where cid='$cid') as c natural join stud_major natural join major natural join has_major natural join (select did,dname from department) as d
