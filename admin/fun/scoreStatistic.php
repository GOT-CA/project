...
from student natural join takes natural join (select cname,cid,credit from course) as c natural join stud_major natural join major natural join has_major natural join (select did,dname from department) as d
    ...
    if($result){
        while($row=mysqli_fetch_object($result)){
            ...
            <tr>
                ...
                <td><a href="getStuScore.php?sid=<?php echo $row->sid."&cid=".$row->cid."&status=".$row->status; ?>">成绩详情</a></td>
            </tr>
            <?php
        }
    }?>
